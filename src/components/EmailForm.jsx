...
export default function EmailForm({renderSending,renderEmail}) {
  ...
  function onSubmit(data) {
      ...
      emailjs.init('GQXElBJm_s0Cy9cgm');        
      emailjs.send('service_8g55ssf', 'template_dvqe7zc', {
          ...
          sml:justify-between'>
            ...
            sml:flex-row sml:mb-6'>
              ...
              <input type="text"
                ...
                placeholder="Nombre..."
                  className="flex input border-transparent border-b-dark-orange bg-transparent text-smoke placeholder:text-smoke-b w-full max-w-xs focus:bg-smoke-a focus:border-b-dark-orange" />
                <small className="mt-2 flex text-danger-red font-bold">
              ...
              })} placeholder="Asunto..." className="input border-transparent border-b-dark-orange bg-transparent text-smoke placeholder:text-smoke-b w-full max-w-xs focus:bg-smoke-a focus:border-b-dark-orange" />
                  <small className="mt-2 flex text-danger-red font-bold">
            ...
            sml:mb-6'>
                ...
                placeholder="Email de contacto..." className="input border-transparent border-b-dark-orange bg-transparent text-smoke placeholder:text-smoke-b w-full max-w-xs focus:bg-smoke-a focus:border-b-dark-orange" />
                            <small className="mt-2 flex text-danger-red font-bold">
            ...
            <div className='flex justify-end 
                sml:mt-4 '>
                  <input type="submit" value="Enviar" className="btn border-dark-orange bg-transparent text-smoke hover:bg-transparent hover:border-dark-orange active:bg-dark-orange active:text-smoke activer:border-smoke transition ease-in-out hover:scale-110 hover:duration-150" />
                </div>
              </div>
            </form>
          </div> 
