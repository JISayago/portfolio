...
function Trabajos() {
  return (
    ...
    <ul className='list-disc p-4 text-white font-mono text-md w-110'>          
        ...
        <li className='m-1 mb-6'><label className='m-1 text-decoration-line: underline font-bold text-base text-dark-orange'>Programador en Censys S.A:</label><label className='text-base'>Programar y mantener sistema bancario. Análisis de datos y corrección de problemas del sistema. 2022-2023</label></li>
        <li className='m-1 mb-6'><label className='m-1 text-decoration-line: underline font-bold text-base text-dark-orange'>Profesor particular:</label><label className='text-base'>Preparación de Alumnos en materias de secundario (Física, Físico-Quimica, Matemática, Geografía). 2019</label></li>
